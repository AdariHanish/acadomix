  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-6 space-y-5">
        ...
        {offerIsActive && (
          <button onClick={() => {
            const msg = `🎉 *${settings.offer_reason} is live at Acadomix!* 🎉\n\nWe are offering massive discounts for a limited time:\n\n🔥 *Mini Projects:* ₹${settings.mini_project_price} ~~(was ₹${settings.original_mini_price})~~\n🔥 *Major Projects:* ₹${settings.major_project_price} ~~(was ₹${settings.original_major_price})~~\n🔥 *Custom Projects:* ₹${settings.custom_project_price} ~~(was ₹${settings.original_custom_price})~~\n\n⏳ *Offer Ends:* ${new Date(settings.offer_end_time!).toLocaleString()}\n\nReply to this message to claim your project now!`;
            navigator.clipboard.writeText(msg);
            alert('Broadcast message copied to clipboard! You can now paste this into your WhatsApp Broadcast List.');
          }}
            className="w-full py-3 bg-[#25D366] hover:bg-[#128C7E] text-white font-semibold rounded-xl text-sm transition-colors flex items-center justify-center gap-2 shadow-lg shadow-[#25D366]/20">
