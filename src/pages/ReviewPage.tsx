...
export default function ReviewPage() {
  ...
  return (
    <div className="min-h-screen vintage-classic-canvas text-white relative overflow-hidden">
      ...
      <div className="absolute top-10 left-10 w-96 h-96 bg-crimson/8 rounded-full blur-[110px] pointer-events-none" />
      <div className="absolute top-1/2 right-10 w-96 h-96 bg-gold/8 rounded-full blur-[110px] pointer-events-none" />
      <div className="absolute bottom-10 left-1/3 w-96 h-96 bg-crimson/6 rounded-full blur-[130px] pointer-events-none" />
